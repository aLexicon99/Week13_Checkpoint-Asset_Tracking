...
namespace Week13_Asset_Tracking
{
    class Function
    {
        public static void AddSampleAssets(List<Assets> assets)
        {
            ...
            // Newer Devices
            Computer macbook = new Computer("Apple", "MacBook Pro M1", 1800, new DateTime(2023, 5, 21));
            Smartphone samsung = new Smartphone("Samsung", "S26 Pro", 980, new DateTime(2024, 12, 19));
